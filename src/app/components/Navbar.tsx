...
import { setCurrentBoardName, getCurrentBoardName } from '@/components/app/redux/features/appSlice'
import { useAppDispatch, useAppSelector } from '@/components/app/redux/hooks'
